...
saveRDS(power_GT, "simulation/results/GT_power.rds")
...
# save the simulation results
saveRDS(power_GB, "simulation/results/GB_power.rds")
...
saveRDS(power_H, "simulation/results/H_power.rds")
...
saveRDS(power_S, "simulation/results/S_power.rds")
