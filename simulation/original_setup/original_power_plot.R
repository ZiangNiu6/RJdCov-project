...
figure_dir <- "simulation/new_figures/original"
...
pdf(file = sprintf("%s/Gaussian_banded.pdf", figure_dir),   # The directory you want to save the file in
    width =  0.8*TEXTWIDTH, # The width of the plot in inches
    height = 0.45*TEXTHEIGHT)

plot(seq(0.05,0.25,0.05), GB_rd_power, type = "o", pch = 19, col = "red",
...
pdf(file = sprintf("%s/Gaussian_topeliz.pdf", figure_dir),   # The directory you want to save the file in
    width =  0.8*TEXTWIDTH, # The width of the plot in inches
    height = 0.45*TEXTHEIGHT)

plot(seq(0.05,0.25,0.05), GT_rd_power, type = "o", pch = 19, col = "red",
...
pdf(file = sprintf("%s/Cauchy.pdf", figure_dir),   # The directory you want to save the file in
    width =  0.8*TEXTWIDTH, # The width of the plot in inches
    height = 0.45*TEXTHEIGHT)


plot(seq(0.02,0.1,0.02), H_rd_power, type = "o", pch = 19, col = "red",
...
pdf(file = sprintf("%s/Sin_dependence.pdf", figure_dir),   # The directory you want to save the file in
    width =  0.8*TEXTWIDTH, # The width of the plot in inches
    height = 0.45*TEXTHEIGHT)


plot(seq(0.1, 0.5, length.out = 5), S_rd_power, type = "o", pch = 19, col = "red",
